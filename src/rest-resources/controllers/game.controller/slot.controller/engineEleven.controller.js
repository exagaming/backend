...
import { PreloadService } from '@src/services/game/slot/engine11/preload.service'
import { TransactService } from '@src/services/game/slot/engine11/transact.service'

export class EngineElevenController {
  /**
